...
class OrderList extends StatelessWidget {
  ...
  void verifyRider(BuildContext context, String orderId) async {
    try {
  ...
  void showOrderDetails(BuildContext context, Map<String, dynamic> order, Map<String, dynamic> sellerDetails, String orderId) async {
    ...
    // Fetch rider details
    String riderUid = order['riderUid'] ?? '';
    String riderName = order['riderName'] ?? 'No rider allocated';
    String riderPhone = order['riderPhone'] ?? 'No rider allocated';
        ...
        return Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ElevatedButton(
                  onPressed: () => verifyRider(context, orderId),
                  child: Text('Verify Rider'),
                ...
                if (riderUid.isNotEmpty)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Rider Details:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue)),
                      Text('Rider UID: $riderUid'),
                      Text('Rider Name: $riderName'),
                      Text('Rider Phone: $riderPhone'),
                    ],
                  )
                else
                  Text('No rider allocated', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red)),
                SizedBox(height: 10),
